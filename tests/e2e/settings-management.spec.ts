...
test.describe("Settings Management E2E Tests", () => {
  ...
  test("should display settings management interface", async ({ page }) => {
    ...
    await expect(
      page.locator('button:has-text("Reset to Defaults")')
    ).toBeVisible();
  });
  ...
  test("should display settings navigation tabs", async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="general-settings-tab"]')
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="email-settings-tab"]')
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="storage-settings-tab"]')
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="security-settings-tab"]')
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="notifications-settings-tab"]')
    ).toBeVisible();
  ...
  test("should display and modify general settings", async ({ page }) => {
    ...
    await expect(
      page.locator('textarea[name="siteDescription"]')
    ).toBeVisible();
    await expect(page.locator('input[name="supportEmail"]')).toBeVisible();
    await expect(
      page.locator('input[type="checkbox"][name="maintenanceMode"]')
    ).toBeVisible();
    await expect(
      page.locator('input[type="checkbox"][name="registrationEnabled"]')
    ).toBeVisible();
  ...
  test("should display and modify email settings", async ({ page }) => {
    ...
    await expect(
      page.locator('input[type="checkbox"][name="smtpSecure"]')
    ).toBeVisible();
  ...
  test("should display and modify security settings", async ({ page }) => {
    ...
    await expect(
      page.locator('input[type="checkbox"][name="requireEmailVerification"]')
    ).toBeVisible();
    await expect(
      page.locator('input[type="checkbox"][name="enableTwoFactor"]')
    ).toBeVisible();

    // Check session settings
    await expect(page.locator('input[name="sessionTimeout"]')).toBeVisible();
    await expect(
      page.locator('input[type="checkbox"][name="forceLogoutInactive"]')
    ).toBeVisible();
  ...
  test("should display and modify notification settings", async ({ page }) => {
    ...
    await expect(
      page.locator('input[type="checkbox"][name="emailNotifications"]')
    ).toBeVisible();
    await expect(
      page.locator('input[type="checkbox"][name="pushNotifications"]')
    ).toBeVisible();
  ...
  test("should display and modify AI settings", async ({ page }) => {
    ...
    await expect(
      page.locator('input[type="checkbox"][name="enableFallback"]')
    ).toBeVisible();
  ...
  test("should reset settings to defaults", async ({ page }) => {
    ...
    await expect(
      page.locator("text=Are you sure you want to reset all settings?")
    ).toBeVisible();
    ...
    // Should show success message
    await expect(
      page.locator("text=Settings reset successfully")
    ).toBeVisible();
  ...
  test("should maintain tab state during operations", async ({ page }) => {
    ...
    if (await smtpHost.isVisible()) {
      ...
      await expect(
        page.locator('[data-testid="email-settings-tab"][aria-selected="true"]')
      ).toBeVisible();
    }
  });
  ...
  test("should display setting descriptions and help text", async ({
    page,
  }) => {
    ...
    for (const tab of tabs) {
      ...
      const helpTexts = page.locator(
        '.text-sm.text-gray-600, .help-text, [data-testid="help-text"]'
      );
