      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Join the community of successful professionals who've transformed
            their careers with our AI-powered resume optimization.
          </p>
        </motion.div>
          ...
          {stats.map((stat, index) => (
            ...
            >
              <div className="glass-effect rounded-3xl p-8 text-center hover-lift group-hover:bg-white/90 transition-all duration-300">
                {/* Gradient Background */}
                <div
                  className={`w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-r ${stat.color} p-0.5`}
                >
