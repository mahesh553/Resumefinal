...
describe("AdminSecurity Component", () => {
  ...
  describe("Security Events", () => {
    ...
    it("should display security events in a table", () => {
      ...
      expect(
        screen.getByText("Admin user successful login")
      ).toBeInTheDocument();
      expect(
        screen.getByText("Failed login attempt - invalid password")
      ).toBeInTheDocument();
    ...
    it("should show event details modal when clicking on an event", async () => {
      ...
      const eventRow = screen
        .getByText("Admin user successful login")
        .closest("tr");
      if (eventRow) {
  ...
  describe("Active Sessions", () => {
    ...
    it("should disable terminate button for current session", () => {
      ...
      const currentSessionRow = screen
  ...
  describe("Accessibility", () => {
    ...
    it("should have proper ARIA labels for form elements", () => {
      ...
      expect(
        screen.getByRole("checkbox", { name: /require mfa/i })
      ).toBeInTheDocument();
    });
